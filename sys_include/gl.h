...
extern void	freepup(int32_t popup);
...
extern void	prefposition(int32_t x1, int32_t x2, int32_t y1, int32_t y2);
...
extern void	winpop();
extern void	winposition(int32_t x1, int32_t x2, int32_t y1, int32_t y2);
extern void	winpush();
