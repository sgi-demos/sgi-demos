...
| SGI demo tape (late 1980s) and GL2 gifts package (1989) | arena, bounce, buttonfly, ideas, insect, jello, logo, newave, libdemo, flight-1988; cedit, sunflower, portlib, port.h, rect.h | none on most files; "unpublished proprietary" legend on flight and on a Notice file in the gifts package | fair use (see section 5), reinforced by SGI having shipped the source to every customer; cedit also shipped as 4Dgifts source on the IRIX 3.3 and 4.0.1 install media | legends retained; see note below on pre-1989 notice |
...
| twilight | Howard Look, SGI, 1991-1992 | GitHub gist (slacy, 2015) | SGI permissive license | ~30 lines of build fixes | express license, conditions met |
...
| twilight.c, GitHub gist by slacy, 10 February 2015 | twilight (Howard Look, SGI, 1991-1992); the repo copy differs by ~30 lines of build fixes | [gist.github.com/slacy/5ec0b38e8fe4da52f40e](https://gist.github.com/slacy/5ec0b38e8fe4da52f40e) (raw revision 8f5089a) | ed79a5ac26761a76afebead06d747ecf647ce0cdcdf3316b682accfab7d0cb1c |
