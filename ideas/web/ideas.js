...
var ASM_CONSTS = {
 ...
 145607: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 145690: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 145759: () => { return window.innerWidth; },  
 145789: () => { return window.innerHeight; }
};
