...
var ASM_CONSTS = {
 ...
 145623: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 145706: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 145775: () => { return window.innerWidth; },  
 145805: () => { return window.innerHeight; }
};
