...
extern void	pdr2(Coord x, Coord y);
...
extern void	rdri();
extern void	rdrs();
extern int  readpixels(short number, Colorindex colors[ ]);
extern int	readRGB(short number, RGBvalue red[ ], RGBvalue green[ ], RGBvalue blue[ ]);
...
extern void sbox(Coord x1, Coord y1, Coord x2, Coord y2);
extern void sboxi(Icoord x1, Icoord y1, Icoord x2, Icoord y2);
extern void sboxs(Scoord x1, Scoord y1, Scoord x2, Scoord y2);
extern void sboxf(Coord x1, Coord y1, Coord x2, Coord y2);
extern void sboxfi(Icoord x1, Icoord y1, Icoord x2, Icoord y2);
extern void sboxfs(Scoord x1, Scoord y1, Scoord x2, Scoord y2);
extern void	resetls();
...
extern void	setdepth(Screencoord near, Screencoord far);
...
extern void	setshade(Colorindex shade);
extern Boolean	setslowcom();
extern void	setvaluator(Device device, int init, int min, int max);
extern long	sginap(long ticks);	/* IRIX libc nap; no-op here (see gl.c) */
...
extern void cpack(unsigned int pack);
